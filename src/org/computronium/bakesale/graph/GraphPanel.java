...
public class GraphPanel extends JPanel
{
	...
	private List<GraphModel> models = new ArrayList<GraphModel>();
	...
	public void paint( Graphics g )
	{
		...
		int x_midpoint = getScreenX((this.scaleMinX + this.scaleMaxX) / 2);
	 ...
	 * @param axisLabel		the new x axis label
	 */
	 ...
	 * @param axisLabel		the new y axis label
	 */
